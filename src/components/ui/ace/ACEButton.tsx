...
export interface ACEButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
...
export const ACEButton: React.FC<ACEButtonProps> = ({
  variant = 'primary',
  size = 'md',
  isLoading = false,
  icon,
  ...
  const baseClasses = 'inline-flex items-center justify-center font-semibold rounded-xl transition-all focus:outline-none cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed';
