            ...
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 shadow-sm">
              ...
              {activeTab === 'EDUCATION' && (
                <div className="space-y-6">
                  ...
                  <div className="relative">
                    <label className="block text-xs font-semibold text-slate-600 dark:text-slate-300 uppercase tracking-wider mb-1.5">
                      Selected Institution / University (All-India Directory)
                    </label>
                    ...
                    <div className="flex gap-2">
                      <div className="relative flex-1">
                        <input
                          ...
                          placeholder="Click to search across 36 States & UTs in India..."
                        />
                      </div>
                      <button
                        type="button"
                        onClick={() => setIsCollegeDropdownOpen(true)}
                        className="px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-indigo-50 dark:bg-indigo-900/30 text-xs font-semibold text-indigo-600 dark:text-indigo-400 hover:bg-indigo-100 dark:hover:bg-indigo-900/50 transition flex items-center gap-1.5"
                      >
                    ...
                    <InstitutionSelectorModal
                      ...
                      onSelect={(inst: Institution) => {
                        ...
                        if (inst.city) setCity(inst.city);
                        if (inst.stateName) setStateVal(inst.stateName);
                        setIsCollegeDropdownOpen(false);
                      }}
                    />
                  </div>
