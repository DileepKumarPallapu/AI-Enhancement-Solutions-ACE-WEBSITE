...
export const PublicProfilePage: React.FC = () => {
  ...
  const roleColors: Record<AccountRole, string> = {
    ...
    RECRUITER: 'bg-cyan-500/10 text-cyan-600 dark:text-cyan-400 border-cyan-500/30',
    JUDGE: 'bg-amber-500/10 text-amber-600 dark:text-amber-400 border-amber-500/30',
    SUPER_ADMIN: 'bg-rose-500/10 text-rose-600 dark:text-rose-400 border-rose-500/30'
  };
